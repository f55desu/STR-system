# Generated by Django 3.2.7 on 2021-11-21 18:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lastname', models.CharField(default=None, max_length=50, null=True, verbose_name='Отчество')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.PROTECT, to='STR.group')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='STR.subject')),
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='STR.teacher')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='STR.group')),
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='STR.subject')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('criterion', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='STR.criterion')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
                ('teacher_subject', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='STR.teacher_subject')),
            ],
            options={
                'verbose_name': 'Оценка',
